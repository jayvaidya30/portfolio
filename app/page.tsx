          ...
          <div className=" flex flex-col max-w-5xl gap-5">
            <div className="flex">
              ...
              <div className=" flex justify-center items-center mt-17 gap-3 ml-3 text-xl text-neutral-500">
                <a href="https://github.com/jayvaidya30">Github</a>
                <a href="https://www.linkedin.com/in/jayvaidya30/">LinkedIn</a>
                <a href="https://x.com/jayvaidya30">𝕏</a>
                <a href="mailto:jayvaidya30@gmail.com">Mail</a>
              </div>
            </div>
