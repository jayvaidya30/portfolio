...
const StatusBadge: React.FC<StatusBadgeProps> = ({
  ...
  return (
    <div
      className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-sm font-medium transition-transform hover:scale-105 cursor-default ${containerStyles[variant]}`}
    >
